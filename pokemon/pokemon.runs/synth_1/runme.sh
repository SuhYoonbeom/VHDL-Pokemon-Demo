...
HD_PWD='C:/Users/Seongjun An/pokemon/pokemon.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pokemon.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pokemon.tcl
