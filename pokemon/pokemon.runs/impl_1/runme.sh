...
HD_PWD='C:/Users/Seongjun An/pokemon/pokemon.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pokemon.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pokemon.tcl -notrace
